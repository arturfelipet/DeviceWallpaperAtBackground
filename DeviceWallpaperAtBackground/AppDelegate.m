...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[self.window drawViewHierarchyInRect:self.window.rootViewController.view.frame afterScreenUpdates:NO];
	...
	[self.window addSubview:[[UIImageView alloc] initWithImage:darkImage]];
